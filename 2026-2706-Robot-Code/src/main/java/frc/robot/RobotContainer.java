  ...
  private void configureBindings() {
    ...
    JoystickButton intakeUpButton =
      new JoystickButton(driverController, XboxController.Button.kY.value);
        ...
        intakeDownButton.whileTrue(new IntakeDownCommand(intakeSubsystem));
        intakeUpButton.whileTrue(new IntakeUpCommand(intakeSubsystem));
        intakeToggleButton.whileTrue(new RunIntakeCommandForward(intakeSubsystem));
